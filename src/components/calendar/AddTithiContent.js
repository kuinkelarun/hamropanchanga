 ...
 * AddTithiContent.js
 *
 * Inner content for adding a tithi — all form state + submit logic —
 * without any modal/backdrop wrapper. Used in:
 *   • AddTithiModal  (mobile bottom-sheet)
 *   • CalendarDayView right panel (desktop split-pane)
 */
...
export default function AddTithiContent({
  isOpen,
  onClose,
  activeDate,
  focusHint,
